...
public class Menu {
	public static void main(String[] args) throws Exception {
		...
		while (true) {
				...
				System.out.println(Cores.ANSI_BLUE_BACKGROUND + Cores.ANSI_BLUE_BACKGROUND
					+ "*****************************************************");
			System.out.println("                                                     ");
			System.out.println("                BANCO BOMFIM                         ");
			System.out.println("                                                     ");
			System.out.println("         Bomfim: A força do seu futuro               " );
			System.out.println("                                                     ");
			System.out.println("*****************************************************");
			System.out.println("                                                     ");
			...
			if (opcao == 9) {
				System.out.println(Cores.TEXT_WHITE_BOLD + "\nBanco Bomfim - Bomfim: A Força do seu Futuro!");
				sobre();
				leia.close();
				System.exit(0);
			}
